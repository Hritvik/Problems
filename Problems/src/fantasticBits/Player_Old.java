...
//		// if (wizard.pos_y < (GOAL_BOTTOM_CENTER - (GOAL_POLE_RADIUS +
//		// SNAFFLE_RADIUS))
//		// && wizard.pos_y > (GOAL_TOP_CENTER + (GOAL_POLE_RADIUS +
//		// SNAFFLE_RADIUS))) {
//		// System.out.println("THROW " + goal_x + " " + wizard.pos_y + " 500");
//		// } else if (wizard.pos_y > (GOAL_BOTTOM_CENTER - (GOAL_POLE_RADIUS +
//		// SNAFFLE_RADIUS))) {
//		// System.out
//		// .println("THROW "
//		// + goal_x
//		// + " "
//		// + (GOAL_BOTTOM_CENTER - (GOAL_POLE_RADIUS + SNAFFLE_RADIUS+100)) +
//		// " 500");
//		// } else if (wizard.pos_y < (GOAL_TOP_CENTER + (GOAL_POLE_RADIUS +
//		// SNAFFLE_RADIUS))) {
//		// System.out.println("THROW " + goal_x + " "
//		// + (GOAL_TOP_CENTER + (GOAL_POLE_RADIUS + SNAFFLE_RADIUS+100))
//		// + " 500");
//		// }
